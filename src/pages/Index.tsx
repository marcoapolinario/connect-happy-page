  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <a
        ...
        rel="noopener"
        aria-label="WhatsApp"
        className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 z-40 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-success flex items-center justify-center shadow-glow hover:scale-110 hover:bg-background transition-[transform,background-color] animate-pulse-glow group"
      >
        <MessageCircle className="w-6 h-6 sm:w-7 sm:h-7 text-success-foreground group-hover:text-secondary transition-colors" />
      </a>
    </div>
  );
};
